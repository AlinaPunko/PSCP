...
// mutation setFaculty($faculty: inFaculty! = { faculty: "ФИТ", faculty_name: "Факультет информационных технологи" } )
// {
// add_faculty(faculty: $faculty)
// {
// faculty,
// faculty_name
// }
...
// mutation Del_teacher($inteacher:String!="СМЛВ      "){
//     del_teacher(teacher:$inteacher)
//     }
const dbconf = {
    user: 'PAA1',
    password: '123',
    connectString: '//localhost/paa_pdb'
}
